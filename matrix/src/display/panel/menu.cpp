...
void MenuBar::init() {
    ...
    connect(this->_new_project_action, &QAction::triggered, this, &MenuBar::newProject); // NOLINT(*-unused-return-value)
    ...
    connect(this->_open_project_action, &QAction::triggered, this, &MenuBar::openProject); // NOLINT(*-unused-return-value)
    ...
    connect(this->_save_project_action, &QAction::triggered, this, &MenuBar::saveProject); // NOLINT(*-unused-return-value)
...
MenuBar::MenuBar(Window *window) : _parent(window) {
    this->init();
}
